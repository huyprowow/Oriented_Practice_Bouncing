...
//lop hinh dang (lop cha cua qua bong vs ho den)
class Shape {
...
//ham tao qua bong ke thua tu Shape
...
//lop evil circle(bong quy) (ho den an may qua bong) ke thua tu Shape
class EvilCircle extends Shape {
  ...
  //phat hien va cham gia bong quy(ho den) vs bong thuong
  collisionDetect() {
